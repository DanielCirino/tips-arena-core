...
topicos = [FILA.FL_PROC_HTML_EQUIPES_EDICAO_COMPETICAO.value]
ID_GRUPO = "grupo-ext-html-equipes-edicao-competicao"


def consumirMensagens():
  """
  Método para consumir processar as mensagens presentes no tópico de extração do html das equipes de uma edição de competição.
  """
