...
topicos = [FILA.FL_EXT_HTML_EDICOES_COMPETICAO.value]
ID_GRUPO = "grupo-ext-html-competicoes-pais"


def consumirMensagens():
  """
  Método para consumir processar as mensagens presentes no tópico de extração do html das edições de uma competição.
  """
...
def processarMensagem(mensagem):
  ...
  try:
    ...
    motor_extracao_flashscore.extrairHtmlEdicoesCompeticao(itemProcessamento.url)
