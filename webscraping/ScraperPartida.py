...
class ScraperPartida(Scraper):
    ...
    def obterUltimasPartidasEquipes(self):
        ...
        try:
            ...
            linhasTabelaPartidasMandante = dadosHtml.select(CSS_TABLE_PARTIDAS_MANDANTE + " tbody tr")
            linhasTabelaPartidasVisitante = dadosHtml.select(CSS_TABLE_PARTIDAS_VISITANTE + " tbody tr")
            linhasTabelaPartidasDiretas = dadosHtml.select(CSS_TABLE_PARTIDAS_DIRETOS + " tbody tr")
